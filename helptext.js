...
shift key</strong> to see the HUD.  The sBooks HUD is divided into four \
...
the previewd section.  In the <strong>expanded view</strong>, all of the sections above the \
...
Clicking a tag adds that tag to the search; clicking the <strong>results count</em> displays the results.  From the \
